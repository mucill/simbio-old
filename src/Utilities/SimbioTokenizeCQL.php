<?php namespace Simbio\Utilities;
...
class SimbioTokenizeCQL() {
   ...
   * @return  string
   **/
  public static function tokenize($str_query, $arr_searcheable_fields, $arr_stop_words = array(), $int_max_words = 20)
  {
    // buffer vars
